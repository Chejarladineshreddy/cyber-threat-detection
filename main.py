...
def neuralNetwork():
    ...
    print("y_test1 shape after OneHotEncoder:", y_test1.shape)  # Debugging line
    ...
    print("y_test1 shape before np.argmax:", y_test1.shape)  # Debugging line
    if len(y_test1.shape) > 1:
        y_test1 = np.argmax(y_test1, axis=1)
    print("y_test1 shape after np.argmax:", y_test1.shape)  # Debugging line
...
title.config(bg='darkorange', fg='white')  
